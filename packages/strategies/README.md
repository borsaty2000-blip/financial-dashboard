...
المحرك لا ينفذ صفقات حقيقية، ولا يرسل أوامر إلى وسيط، ولا يدعي أن نتائج backtest تنبؤ. تم تركيب واجهة React Flow في route lazy منفصل؛ وجود الرسم لا يغير حدود الخطر أو التفويض، وكل edge جديد يمر عبر `validateStrategy` قبل قبوله.
